...
class ReferralsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post referrals_url, params: { referral: { category: @referral.category, comment: @referral.comment, company: @referral.company, link: @referral.link, title: @referral.title } }
    end
  ...
  test "should update referral" do
    patch referral_url(@referral), params: { referral: { category: @referral.category, comment: @referral.comment, company: @referral.company, link: @referral.link, title: @referral.title } }
